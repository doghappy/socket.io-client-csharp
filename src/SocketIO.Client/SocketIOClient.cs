...
using SocketIO.Client.Transport.Http;
using SocketIO.Client.Transport.WebSockets;
using SocketIO.Client.UriConverters;
using SocketIO.Core;
using SocketIO.Serializer.Core;
using SocketIO.Serializer.SystemTextJson;

[assembly: InternalsVisibleTo("SocketIO.Client.UnitTests, PublicKey=002400000480000094000000060200000024" +
