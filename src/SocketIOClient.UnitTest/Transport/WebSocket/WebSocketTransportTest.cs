...
public class WebSocketTransportTest
{
    ...
    // public async Task OnReceived(EngineIO eio, TransportMessageType type, byte[] data, object expected)
    // {
    //     IMessage msg = null;
    //     int offset = 0;
    //     var mockWs = new Mock<IClientWebSocket>();
    ...
    //             if (eio == EngineIO.V3 && type == TransportMessageType.Binary)
    //             {
    //                 offset += 1;
    //                 max -= 1;
    //             }
    ...
    //             offset += count;
    //             bool endOfMessage = offset >= data.Length;
    ...
    // }
    //
    // private static IEnumerable<object[]> OnReceivedCases => OnReceivedTupleCases.Select(x => new object[] { x.eio, x.type, x.data, x.expected });
    //
    // private static IEnumerable<(EngineIO eio, TransportMessageType type, byte[] data, object expected)> OnReceivedTupleCases
    // {
    //     get
    //     {
    //         return new (EngineIO eio, TransportMessageType type, byte[] data, object expected)[]
    //         {
    //             // (
    //             //     EngineIO.V3,
    //             //     TransportMessageType.Text,
    //             //     Encoding.UTF8.GetBytes("0{\"sid\":\"LgtKYhIy7tUzKHH9AAAB\",\"upgrades\":[\"websocket\"],\"pingInterval\":10000,\"pingTimeout\":5000}"),
    //             //     new
    //             //     {
    ...
    //             //     EngineIO.V4,
    //             //     TransportMessageType.Text,
    //             //     Encoding.UTF8.GetBytes("42[\"hello\",\"world\"]"),
    //             //     new
    //             //     {
