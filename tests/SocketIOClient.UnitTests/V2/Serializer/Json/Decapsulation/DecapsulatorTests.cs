...
public class DecapsulatorTests
{
    ...
    public void DecapsulateEventMessage_WhenCalled_AlwaysPass(string text, int id, [CanBeNull] string ns, string data)
    {
        var decapsulator = new Decapsulator();
    ...
    public void DecapsulateBinaryEventMessage_WhenCalled_AlwaysPass(string text, int id, [CanBeNull] string ns, string data, int bytesCount)
    {
        var decapsulator = new Decapsulator();
