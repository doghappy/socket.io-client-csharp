...
{
    [TestClass]
    public class V2HttpStjNspTests : SystemTextJsonTests
    {
        ...
        protected override string ServerUrl => "http://localhost:11210/nsp";
        protected override string ServerTokenUrl => "http://localhost:11211/nsp";

        [TestMethod]
        public async Task Should_automatically_upgrade_to_websocket()
        {
            var io = new SocketIO("http://localhost:11200/nsp", new SocketIOOptions
            {
                EIO = EngineIO.V3,
                AutoUpgrade = true,
                Reconnection = false,
